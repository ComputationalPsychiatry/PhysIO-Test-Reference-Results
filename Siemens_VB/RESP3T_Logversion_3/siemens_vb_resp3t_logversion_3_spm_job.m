...
matlabbatch{1}.spm.tools.physio.log_files.respiration = {'fingertapping.resp'};
matlabbatch{1}.spm.tools.physio.log_files.scan_timing = {'fingertapping_first_volume.dcm'};
...
matlabbatch{1}.spm.tools.physio.scan_timing.sqpar.TR = 1.8;
matlabbatch{1}.spm.tools.physio.scan_timing.sqpar.Ndummies = 0;
matlabbatch{1}.spm.tools.physio.scan_timing.sqpar.Nscans = 55;
