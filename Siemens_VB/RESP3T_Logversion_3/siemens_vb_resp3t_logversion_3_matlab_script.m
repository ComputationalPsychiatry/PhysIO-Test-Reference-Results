...
physio.log_files.respiration = {'fingertapping.resp'};
physio.log_files.scan_timing = {'fingertapping_first_volume.dcm'};
physio.log_files.relative_start_acquisition = 0;
physio.log_files.align_scan = 'first';
physio.scan_timing.sqpar.Nslices = 31;
physio.scan_timing.sqpar.TR = 1.8;
physio.scan_timing.sqpar.Ndummies = 0;
physio.scan_timing.sqpar.Nscans = 55;
