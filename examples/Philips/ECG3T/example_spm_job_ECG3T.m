%-----------------------------------------------------------------------
% Job saved on 24-Jan-2015 10:28:55 by cfg_util (rev $Rev: 6134 $)
% spm SPM - SPM12 (6225)
...
matlabbatch{1}.spm.tools.physio.thresh.scan_timing.gradient_log.zero = 0.4;
matlabbatch{1}.spm.tools.physio.thresh.scan_timing.gradient_log.slice = 0.45;
